      ...
      <div class="flex items-center justify-between">
        ...
        <div class="md:hidden">
          <button @click="toggleDrawer" aria-label="Toggle navigation">
            <svg 
              class="h-10 w-10 fill-current text-black"
        ...
        <div class="hidden md:block">
          <ul class="flex space-x-8 text-sm font-sans">
            ...
            <li><NuxtLink to="#" @click="toggleServicesDropdown">Services</NuxtLink>
            <transition name="fade">
              <ul v-if="servicesDropdownOpen" class="absolute mt-2 space-y-2 bg-white shadow-md rounded-lg p-2">
                <li><NuxtLink to="/website" class="block text-gray-800 hover:text-blue-500">Website</NuxtLink></li>
                <li><NuxtLink to="/social-media" class="block text-gray-800 hover:text-blue-500">Social Media</NuxtLink></li>
                <li><NuxtLink to="/seo" class="block text-gray-800 hover:text-blue-500">SEO</NuxtLink></li>
                <li><NuxtLink to="/paid-media" class="block text-gray-800 hover:text-blue-500">Paid Media</NuxtLink></li>
                <li><NuxtLink to="/content-creation" class="block text-gray-800 hover:text-blue-500">Content Creation</NuxtLink></li>
                <li><NuxtLink to="/print-advertising" class="block text-gray-800 hover:text-blue-500">Print Advertising</NuxtLink></li>
              </ul>
            </transition>
            </li>
            <li><NuxtLink to="/consultation">Consultation</NuxtLink></li>
