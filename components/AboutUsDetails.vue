...
.about-section:nth-child(4n+1) .image-wrapper,
.about-section:nth-child(4n+3) .image-wrapper {
  margin-left: 50px;
}

.about-section:nth-child(4n+2) .image-wrapper,
.about-section:nth-child(4n) .image-wrapper {
  margin-right: 50px;
  margin-left: auto;
}
